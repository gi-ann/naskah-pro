...
let firebaseConfig = {
  apiKey: "API_KEY_ASLI_KAMU_DISINI", 
  authDomain: "naskah-pro.firebaseapp.com",
  projectId: "naskah-pro",
  storageBucket: "naskah-pro.appspot.com",
...
export default function App() {
  ...
  const createNewScript = async () => {
    ...
    // Reset pengaturan judul ke default untuk naskah baru
  ...
  const createImportedScript = async (title, initialBlocks) => {
    ...
    // Reset pengaturan judul ke default untuk naskah impor
    setTitleFont('roboto'); setTitleFontSize(64); setTitleFontWeight(400); 
    setTitlePaddingTop(48); setTitlePaddingBottom(48); setTitleLineHeight(1.1);
  ...
  useEffect(() => {
    ...
    const saveToCloud = async () => {
      ...
      // FIX: Optimistic Update - Simpan ke memori layar terlebih dahulu agar tidak hilang saat klik tombol 'Kembali'
      setScriptsList(prev => {
        const list = [...prev];
